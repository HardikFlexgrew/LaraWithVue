  ...
  <header class="header-modern aesthetic-shadow">
    <div class="header__container-modern">
      ...
      <div class="header__actions-modern">
        <button class="sign-in-btn-modern hide-on-mobile-modern" v-if="!userStore.loggedIn">
          <RouterLink class="nav-link-modern" :to="{name : 'login'}">
            <svg width="19" height="19" fill="none" style="margin-right:4px;vertical-align:middle"><path d="M13 9H5M9 5l-4 4 4 4" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/><circle cx="9.5" cy="9.5" r="8.2" stroke="#bae6fd" stroke-width="1"/></svg>
            Sign In
          </RouterLink>
        </button>
        ...
        <template v-if="userStore.loggedIn">
          <div class="modern-user-pill user-pill-glass" style="margin-right:0;">
            ...
            <button class="sign-in-btn-modern hide-on-mobile-modern nav-link-icon-logout" style="margin-left:1.1em;" @click="Logout()">
