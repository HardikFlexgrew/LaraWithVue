...
function P2(t3, i4) {
  if (i4) {
    if (!O4(i4, R2)) Object.defineProperty(i4, R2, { value: t3 });
...
var q3 = { function: (t3) => t3.constructor, string: B2 };
function D(t3, i4, e3) {
  let s3 = C(i4);
  let n3 = 0;
  while (n3 < s3.length) {
    const i5 = s3[n3++];
    if (O4(t3, i5)) s3 = e3(s3, t3[i5]);
  }
  return s3;
}
function Y(t3, i4) {
...
function L(t3, i4) {
  ...
  for (let i5 = 0; i5 < e3.length; i5++) D(t3, e3[i5], s3);
}
function U(t3, i4) {
  if (!i4 || i4.skipValidate !== false) L(t3, i4 && i4.anyAction || "manage");
  return (i5) => D(t3, i5, k);
}
function G(t3, i4, e3) {
...
var W = (t3) => ({ value: t3.value, prev: t3.prev, next: t3.next });
var X = () => ({ rules: [], merged: false });
...
var ft = (t3) => {
  let i4;
  return (e3) => {
    if (typeof i4 === "undefined") i4 = t3.every((t4) => t4.indexOf("*") === -1) ? null : at(t3);
...
var yt = (t3) => `Cannot execute "${t3.action}" on "${t3.subjectType}"`;
var pt = function t2(i4) {
  this.message = i4;
};
...
//# sourceMappingURL=chunk-BLKMDIFJ.js.map
